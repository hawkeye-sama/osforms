...
faq:
  ...
  - question: 'Where does my form data live if I use OSForms?'
    answer: 'Submissions are stored so you can view them anytime and export everything to CSV. Integrations forward each submission to your own services (your Resend account, your Google Sheet, your webhook) using your keys. You can also self-host OSForms against your own MongoDB to keep everything on your infrastructure.'
  - question: 'How do I stop spam without forcing a captcha on users?'
    answer: 'A honeypot field is the frictionless option: add a hidden input that real users never fill, and discard any submission that arrives with it populated. OSForms supports a configurable honeypot field plus optional reCAPTCHA or hCaptcha if you want a captcha as well; Cloudflare Turnstile support is in progress.'
---
...
- **Spam protection**: a configurable honeypot field, plus optional reCAPTCHA or hCaptcha (Turnstile support is tracked in [issue #17](https://github.com/hawkeye-sama/osforms/issues/17))
