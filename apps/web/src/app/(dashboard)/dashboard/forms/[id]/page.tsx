...
import { FormBuilder } from '@/components/dashboard/form-builder/FormBuilder';
      ...
      >
        ...
        <TabsContent value="setup" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <CodeSnippets endpointUrl={endpointUrl} slug={form.slug} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="builder">
          <FormBuilder formId={id} initialSchema={form.formSchema} />
        </TabsContent>
      </Tabs>
    </div>
  );
